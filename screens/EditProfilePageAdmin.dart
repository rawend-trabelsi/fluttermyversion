...
class EditProfilePageAdmin extends StatefulWidget {
  ...
  @override
  _EditProfilePageAdminState createState() => _EditProfilePageAdminState();
}

class _EditProfilePageAdminState extends State<EditProfilePageAdmin> {
  ...
  Future<void> _updateProfile() async {
    ...
    final success = await AuthService().updateProfile(
      ...
      currentPasswordController.text.isEmpty ? "" : currentPasswordController
          .text,
            ...
            child: Column(
              ...
              children: [
                Icon(
                  ...
                  // Success icon with the desired color
                  size: 80,
                ),
                SizedBox(height: 20),
                Text(
            ...
            child: Column(
              children: [
                SizedBox(
                  height: 120,
                  child: Image.asset(
                      'assets/images/edit_profile.png', fit: BoxFit.contain),
                ),
                const SizedBox(height: 20),
                TextFormField(
                  controller: usernameController,
                  decoration: InputDecoration(
                    labelText: 'Nom du Admin',
